...
def gcn_no_norm(edge_index, edge_weight=None, num_nodes=None, beta=1.0,
                add_self_loops=True, dtype=None):
...
def gcn_diffusion(edge_index, alpha=0.5, edge_weight=None, num_nodes=None,
                  beta=1.0, add_self_loops=True, dtype=None):
...
def gcn_norm(edge_index, edge_weight=None, num_nodes=None,
             beta=1.,
             add_self_loops=True, dtype=None, alpha=0.5):
...
def gcn_norm_sym(edge_index, alpha=0.5, edge_weight=None, num_nodes=None,
                 beta=1.0, add_self_loops=True, dtype=None):
...
def gcn_diffusion(edge_index, alpha=0.5, edge_weight=None, num_nodes=None, beta=1.0,
             add_self_loops=True, dtype=None):
...
class AggregationScheme(MessagePassing):
    ...
    def __init__(self, beta: float = 1.0, cached: bool = False,
                 add_self_loops: bool = True, normalize: bool = True,
                 gnn_type: str = "normal", alpha: float = 0.5,
                ...
                if cache is None:
                    if self.gnn_type == "normal":
                        ...
                        edge_index, edge_weight = gcn_diffusion(  # yapf: disable
                            edge_index,  self.alpha, edge_weight,
            ...
            if isinstance(edge_index, Tensor):
                ...
                if cache is None:
                    if self.gnn_type == "normal":
                        edge_index, edge_weight = gcn_norm( # yapf: disable
                            edge_index, edge_weight, x.size(self.node_dim),
                            self.beta, self.add_self_loops, alpha=self.alpha)
                    elif self.gnn_type == "diffusion":
                        edge_index, edge_weight = gcn_diffusion( # yapf: disable
                            edge_index,  self.alpha, edge_weight,
                            x.size(self.node_dim),
