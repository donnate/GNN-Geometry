...
def gcn_norm(edge_index, edge_weight=None, num_nodes=None,
             add_self_loops=True, flow="source_to_target", dtype=None, alpha=0.5, beta = 1.0):
...
def gcn_norm_rw(edge_index, edge_weight=None, num_nodes=None,
             add_self_loops=True, flow="source_to_target", dtype=None, alpha=0.5, beta=1.):
...
def gcn_norm_sym(edge_index, edge_weight=None, num_nodes=None,
             add_self_loops=True, dtype=None, alpha=0.5, beta=1.0):
                ...
                if cache is None:
                    if self.gnn_type == "symmetric":
                        edge_index, edge_weight = gcn_norm(  # yapf: disable
                            ...
                            self.add_self_loops, alpha = self.alpha, beta = self.beta)
                    elif self.gnn_type == "RW":
                        print("here")
                        edge_index, edge_weight = gcn_diffusion(  # yapf: disable
                            edge_index,  edge_weight, x.size(self.node_dim),
